...
SALES_QTY_COL_ALIASES = [
    ...
    "销量", "真实销量数", "销售数量", "销售结果",
    # v1.4.41.5 起页面展示层统一改名为"累计销量结果" → 这里也支持直接识别
    "累计销量结果",
]
# "销售情况" / "爆旺平滞" 标签列 — 本质也是销量/销售表现的有序标签，
# 展示时重命名为「上架30天销售情况」让含义更清晰
SALES_LABEL_COL_ALIASES = [
    "销售情况", "上架销售情况", "销售标签", "销量标签",
    "销售表现", "上架表现", "爆旺平滞",
    # v1.4.41.5 起页面展示层统一改名为"上架30天销售情况" → 这里也支持直接识别
    "上架30天销售情况",
]
